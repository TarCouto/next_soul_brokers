...
export default function CarouselCard({ items }: CarouselProps) {
    ...
    return (
        <div className="relative w-full bg-customBlack justify-center lg:w-full lg:h-[903px]  flex text-white p-36 lg:flex  ">
            <div className="px-8 w-full lg:-ml-[230px] " >
                <div className="grid grid-cols-12 items-start lg:-mt-[150px]">
                    <div className="col-span-12 lg:col-span-6">
                        <h2 className="text-4xl font-bold mt-24">Novidades</h2>
                        <p className="text-gray-400  lg:w-5/5 mt-6">
                    ...
                    <div className="col-span-12 lg:col-span-6 flex justify-center lg:justify-end items-start space-x-2 mt-4 lg:mt-24 -mr-52">
                        <button
